# Generated by Django 4.2.7 on 2025-07-14 22:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('frisbee_simulator_web', '0036_ufapoint'),
    ]

    operations = [
        migrations.CreateModel(
            name='UFAPlayerPointStat',
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ufa_point_stats_for_game', to='frisbee_simulator_web.game')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ufa_point_stats', to='frisbee_simulator_web.player')),
                ('point', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ufa_player_stats', to='frisbee_simulator_web.point')),
            ],
        ),
    ]
